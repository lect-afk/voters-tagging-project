...
@section('content')
    <div class="container my-5">
        ...
        <form class="row g-2 mb-3" method="GET" action="{{ route('province.index') }}" role="search">
            ...
            <div class="col-6 col-md-1">
                <a href="{{ route('province.create') }}" class="button-index w-100">
                            ...
                            <td class="align-middle">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('province.show', $province->id) }}" class="icon-link" title="Show">
                                                <i class="fas fa-eye"></i> Show
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ route('province.edit', $province->id) }}" class="icon-link" title="Edit">
